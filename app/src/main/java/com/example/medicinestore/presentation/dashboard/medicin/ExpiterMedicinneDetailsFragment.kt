...
class ExpiterMedicinneDetailsFragment : Fragment() {
  ...
  lateinit var activityUtil: MSActivityUtil
    ...
    override fun onCreateView(
        ...
        binding.expireMedicineCompanyTv.text = requireArguments().getString("company")
        binding.expireMedicineDateTv.text = requireArguments().getString("date")
        binding.expireMedicinePriceTv.text = requireArguments().getString("price")
        binding.expireMedicineSelfTv.text = requireArguments().getString("self")
        binding.expireMedicineRowTv.text = requireArguments().getString("row")
        binding.expireMedicineColumnTv.text = requireArguments().getString("column")
        binding.expireMedicineDetailsTv.text = requireArguments().getString("details")
